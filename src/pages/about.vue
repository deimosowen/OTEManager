  ...
  <div class="mx-auto max-w-3xl pb-12">
    ...
    >
      ...
      <div class="relative">
        ...
        <p class="mt-3 max-w-xl text-base leading-relaxed text-white/95">
          ...
          обзор ВМ, запуск сценариев в TeamCity, шаблоны сборок и сценарии автоматизаций с наглядным редактором графа.
        </p>
    ...
    <section class="mt-10">
      ...
      <p class="mt-3 text-[15px] leading-relaxed text-slate-600">
        ...
        квот, интеграция с TeamCity для старта, остановки и удаления окружений по тегам, шаблоны сборок и
        сценарии автоматизации (граф шагов с расписанием и действиями).
      </p>
    </section>
...
const featureCards = [
  ...
  },
  {
    ...
    text: 'YAML с плейсхолдерами и параметры для TeamCity. Общий шаблон можно открыть и править с любой учётной записью; группы каталога помогают фильтровать списки. Личный шаблон виден только создателю.',
  },
  {
    title: 'Создание OTE',
  ...
  {
    title: 'Автоматизации',
    text: 'Сценарии с блоками на холсте: расписание, условия, действия; ручной запуск с главной. Новые возможности можно посмотреть в экскурсии из анонса и в демонстрационной песочнице редактора.',
  },
]
</script>
