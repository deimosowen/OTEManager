...
const featureCards = [
  ...
  },
  {
    ...
    text: 'YAML с плейсхолдерами и параметры для TeamCity. Общие шаблоны делятся по группам каталога: редактировать и удалять может любой коллега, которому шаблон доступен, не только создатель.',
  },
  {
    title: 'Создание OTE',
