...
Кратко по домену: каталог **OTE** и ресурсов в Yandex Cloud, **шаблоны сборок** (YAML + параметры TeamCity; общие шаблоны привязаны к группам каталога — редактировать и удалять может любой пользователь, которому шаблон **виден**, не только автор), создание/обновление окружений через **TeamCity**, раздел **«Автоматизации»** — сценарии с графом блоков (расписание, условия, действия, ручной запуск с главной), анонсы фич с экскурсией **driver.js** и демонстрационной песочницей редактора.
