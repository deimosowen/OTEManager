...
Кратко по домену: каталог **OTE** и ресурсов в Yandex Cloud, **шаблоны сборок** (YAML + параметры TeamCity; общий шаблон по прямой ссылке или id доступен любому вошедшему пользователю на просмотр и правку; группы каталога влияют на отображение в списках; личный шаблон — только автор), создание/обновление окружений через **TeamCity**, раздел **«Автоматизации»** — сценарии с графом блоков (расписание, условия, действия, ручной запуск с главной), анонсы фич с экскурсией **driver.js** и демонстрационной песочницей редактора.
...
│   ├── tours/           # экскурсии driver.js и демо-данные (в т.ч. песочница автоматизаций)
